// SLICE 12: Monte Carlo — submit simulation, render fan chart of percentile bands.
  ...
  return (
    <section className="flex min-h-[60vh] items-center justify-center p-8">
      <div className="w-full max-w-md rounded-md border border-bd-subtle bg-bg-surface p-8 text-center shadow-panel">
        <p className="font-mono text-xs uppercase tracking-widest text-text-muted">Slice 12</p>
        <h1 className="mt-3 font-display text-2xl text-text-primary">Monte Carlo</h1>
